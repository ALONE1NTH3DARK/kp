  ...
  var S = function (g) {
    ...
    function Na(a, b) {
      ...
      if (c) {
        ...
        d.DT_RowClass &&
          ...
          g(c).removeClass(b.__rowc.join(" ")).addClass(d.DT_RowClass));
            ...
            if (g.isArray(a) || a instanceof g)
              ...
              a.nodeName && "tr" === a.nodeName.toLowerCase()
                ...
                : ((c = g("<tr><td/></tr>").addClass(b)),
                  (g("td", c).addClass(b).html(a)[0].colSpan = ba(d)),
                  e.push(c[0]));
          };
        f(a, b);
    ...
    m.defaults = {
      ...
      oLanguage: {
        ...
        sInfo: "Показано от _START_ до _END_ из _TOTAL_ товаров",
        sInfoEmpty: "Показано от 0 до 0 из 0 товаров",
        sInfoFiltered: "(Отфильтровано из _MAX_ товаров)",
        sInfoPostFix: "",
        sDecimal: "",
        sThousands: ",",
        sLengthMenu: "Показать _MENU_ товаров",
